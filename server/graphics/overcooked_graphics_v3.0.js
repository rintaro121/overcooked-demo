...
class OvercookedScene extends Phaser.Scene {
    ...
    set_state(state) {
        ...
        this.hud_data.intent = state.intent;
...
//            console.log(hud_data.potential)
        ...
        if (typeof(hud_data.intent) !== 'undefined'){
            console.log(hud_data.intent)
            this._drawIntent(hud_data.intent, sprites, board_height);
        }
    ...
    /*
    _drawIntent(intent, sprites, board_height) {
        intent = 'Next Action' + intent;
        if (typeof(sprites['intent']) !== 'undefined') {
            sprites['intent'].setText(intent);
        }
        else {
            sprites['intent'] = this.add.text(
                120, board_height + 115, intent,
                {
                    font: "20px Arial",
                    fill: "red",
                    align: "left"
